...
public interface GalleryService {
    ...
    Map<String, String> getInitialState();

    void updateState(String componentId, String value);

    VisualResult getGridData();

    VisualResult getChartData();

    VisualResult getGanttData();
}
